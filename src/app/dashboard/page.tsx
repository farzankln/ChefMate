      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 bg-gray-800 rounded-lg p-6 border border-gray-700">
          ...
          <p className="text-gray-300 leading-relaxed">
            Welcome to your Chef Mate dashboard! Here you&apos;ll be able to organize
            your recipes, plan your meals, and track your culinary adventures.
            We&apos;re excited to help you become a better cook.
          </p>
          <div className="mt-6">
            <button
              onClick={() => router.push("/")}
